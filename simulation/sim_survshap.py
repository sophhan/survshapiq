...
explanation_df_rf_ti = survshapiq_func.survshapiq(model_rf_ti, data_x_ti, x_new_ti, time_stride=10, budget=2**8, max_order=2, approximator="exact", feature_names = data_x.columns)
explanation_df_cox_ti = survshapiq_func.survshapiq(model_cox_ti, data_x_ti, x_new_ti, time_stride=10, budget=2**8, max_order=2, approximator="exact", feature_names = data_x.columns)
explanation_df_gbsa_ti = survshapiq_func.survshapiq(model_gbsa_ti, data_x_ti, x_new_ti, time_stride=10, budget=2**8, max_order=2, approximator="exact", feature_names = data_x.columns)

# Plot the interaction values
survshapiq_func.plot_interact(explanation_df_rf_ti, model_rf_ti, time_stride=10, x_new = x_new_ti, save_path = "/home/slangbei/survshapiq/survshapiq/simulation/plots/plot_rf_ti_exact.png") 
survshapiq_func.plot_interact(explanation_df_cox_ti, model_cox_ti, time_stride=10, x_new = x_new_ti, save_path = "/home/slangbei/survshapiq/survshapiq/simulation/plots/plot_cox_ti_exact.png") 
survshapiq_func.plot_interact(explanation_df_gbsa_ti, model_gbsa_ti, time_stride=10, x_new = x_new_ti, save_path = "/home/slangbei/survshapiq/survshapiq/simulation/plots/plot_gbsa_ti_exact.png") 
...
# Explain the first row of x_new for every third time point
explanation_df_rf_td = survshapiq_func.survshapiq(model_rf_td, data_x_td, x_new_td, time_stride=10, budget=2**8, max_order=2, approximator="exact", feature_names = data_x.columns)
explanation_df_cox_td = survshapiq_func.survshapiq(model_cox_td, data_x_td, x_new_td, time_stride=10, budget=2**8, max_order=2, approximator="exact", feature_names = data_x.columns)
explanation_df_gbsa_td = survshapiq_func.survshapiq(model_gbsa_td, data_x_td, x_new_td, time_stride=10, budget=2**8, max_order=2, approximator="exact", feature_names = data_x.columns)

# Plot the interaction values
survshapiq_func.plot_interact(explanation_df_rf_td, model_rf_td, time_stride=10, x_new = x_new_td, save_path = "/home/slangbei/survshapiq/survshapiq/simulation/plots/plot_rf_td_exact.png")
survshapiq_func.plot_interact(explanation_df_cox_td, model_cox_td, time_stride=10, x_new = x_new_td, save_path = "/home/slangbei/survshapiq/survshapiq/simulation/plots/plot_cox_td_exact.png") 
survshapiq_func.plot_interact(explanation_df_gbsa_td, model_gbsa_td, time_stride=10, x_new = x_new_td, save_path = "/home/slangbei/survshapiq/survshapiq/simulation/plots/plot_gbsa_td_exact.png") 
