...
survshapiq_func.plot_samplewise_mean_abs_attributions(explanation_df_rf, model_name="Random Forest", save_path="/home/slangbei/survshapiq/survshapiq/support/global_plots/rf_attributions.png")
explanation_df_rf.to_csv("/home/slangbei/survshapiq/survshapiq/support/explanations/rf_attributions.csv", index=False)
...
survshapiq_func.plot_samplewise_mean_abs_attributions(explanation_df_cox, model_name="Cox Model", save_path="/home/slangbei/survshapiq/survshapiq/support/global_plots/cox_attributions.png")
explanation_df_cox.to_csv("/home/slangbei/survshapiq/survshapiq/support/explanations/cox_attributions.csv", index=False)
...
survshapiq_func.plot_samplewise_mean_abs_attributions(explanation_df_gbsa, model_name="GBSA Model", save_path="/home/slangbei/survshapiq/survshapiq/support/global_plots/gbsa_attributions.png")
explanation_df_gbsa.to_csv("/home/slangbei/survshapiq/survshapiq/support/explanations/gbsa_attributions.csv", index=False)
...
# Generate final annotated DataFrames, plots and save dataframes with explanations
explanation_df_coxtime = survshapiq_func.annotate_explanations(explanations_coxtime, model_coxtime, sample_idxs=range(len(data_x_full_nn)), time_stride=time_stride, data_x_train=x_train)
survshapiq_func.plot_samplewise_mean_abs_attributions(explanation_df_coxtime, model_name="Coxtime Model", save_path="/home/slangbei/survshapiq/survshapiq/support/global_plots/coxtime_attributions.png")
explanation_df_coxtime.to_csv("/home/slangbei/survshapiq/survshapiq/support/explanations/coxtime_attributions.csv", index=False)


# Print top 5 sample_idx per feature for each model
explanation_df_cox = pd.read_csv("/home/slangbei/survshapiq/survshapiq/support/explanations/cox_attributions.csv")
explanation_df_gbsa = pd.read_csv("/home/slangbei/survshapiq/survshapiq/support/explanations/gbsa_attributions.csv")
explanation_df_rf = pd.read_csv("/home/slangbei/survshapiq/survshapiq/support/explanations/rf_attributions.csv")
...
# Save to CSV
summary_df.to_csv("/home/slangbei/survshapiq/survshapiq/support/explanations/top_feature_attributions.csv", index=False)


# Plot interesting observations
