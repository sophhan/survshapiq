...
def generate_plots_for_instance(i, idx):
    try:
        ...
        explanations = {
            #"rf": survshapiq_func.survshapiq(model_rf, data_x_full, x_new, time_stride, 256, 2, main_features),
            ...
            #"coxtime": survshapiq_func.survshapiq_pycox(model_coxtime, x_test, x_new, time_stride, 256, 2, main_features)
        }
