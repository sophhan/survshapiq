...
base_path = "/home/slangbei/survshapiq/survshapiq/flchain/plots"
...
random_indices = np.array([2546, 2024, 1948, 2646, 1093, 4271, 33])  # Example indices for testing

main_features = data_x_test_df.columns.tolist()
interactions = [
    ["hormonal_therapy * menopause", "hormonal_therapy * tumor_grade", "hormonal_therapy * age",
     "hormonal_therapy * tumor_size", "hormonal_therapy * progesterone_receptors", "hormonal_therapy * estrogen_receptors"],
    ["menopause * tumor_grade", "menopause * age", "menopause * tumor_size",
     "menopause * progesterone_receptors", "menopause * estrogen_receptors"],
    ["tumor_grade * age", "tumor_grade * tumor_size", 
     "tumor_grade * progesterone_receptors", "tumor_grade * estrogen_receptors"],
    ["age * tumor_size", "age * progesterone_receptors", "age * estrogen_receptors"],
    ["tumor_size * progesterone_receptors", "tumor_size * estrogen_receptors"],
    ["progesterone_receptors * estrogen_receptors"]
]
...
def generate_plots_for_instance(i, idx):
    try:
        x_new = data_x_full[[idx]]
        
        explanations = {
            #"rf": survshapiq_func.survshapiq(model_rf, data_x_full, x_new, 20, 256, 2, main_features),
            "cox": survshapiq_func.survshapiq(model_cox, data_x_full, x_new, time_stride, 256, 2, main_features),
            "gbsa": survshapiq_func.survshapiq(model_gbsa, data_x_full, x_new, time_stride, 256, 2, main_features)
            #"coxtime": survshapiq_func.survshapiq_pycox(model_coxtime, data_x_full, x_new, 20, 256, 2, main_features)
        }
